...
export default function Features() {
  return (
    <section id="features" className="divide-y divide-line border-b border-line">
      
      {/* ─── BAND 1: ATTENDANCE & FEES (Deeper Paper Band: #EFEAE0) ─────────── */}
      <div className="py-20 px-4 sm:px-6 lg:px-8 bg-paper-band">
              ...
              <div className="paper-card rounded-md shadow-ledger overflow-hidden">
                ...
                <div className="p-4 sm:p-5 bg-paper-light space-y-3">
                  <table className="w-full text-left font-mono text-xs">
                    ...
                    <tbody className="divide-y divide-line/60">
                      ...
                      <tr>
                        ...
                        <td className="py-2.5 text-right font-sans text-xs text-alert font-medium">SMS Dispatched 08:31</td>
                      </tr>
                      <tr>
                        <td className="py-2.5 text-ink-subtle">#03</td>
                        <td className="py-2.5 font-medium text-ink">Devin Reynolds</td>
                        <td className="py-2.5 text-brass-dark font-semibold">Late (Medical)</td>
                  ...
                  <div className="pt-2 border-t border-line flex items-center justify-between text-xs font-mono text-ink-muted">
                    <span>Register Summary: <strong className="text-ledger font-semibold">27 Present</strong> · <strong className="text-alert font-semibold">1 Absent</strong></span>
                    <span className="text-ledger font-semibold">Register Sealed</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="paper-card rounded-md shadow-ledger overflow-hidden">
                ...
                <div className="p-4 sm:p-5 bg-paper-light space-y-3">
                  ...
                  <div className="pt-2 border-t border-line flex items-center justify-between text-xs font-mono text-ink-muted">
                    ...
                    <span className="text-ledger font-semibold">$22,400 Collected (90.6%)</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="py-20 px-4 sm:px-6 lg:px-8 bg-paper">
        <div className="max-w-6xl mx-auto space-y-24">
            ...
            <div className="lg:col-span-7">
              <div className="paper-card rounded-md shadow-ledger p-5 sm:p-6 bg-paper-light space-y-4 border border-line">
                <div className="border-b border-line pb-3 flex items-start justify-between">
                  <div>
                    <p className="font-mono text-[10px] text-brass-dark uppercase tracking-wider font-semibold">Official Terminal Transcript</p>
                  ...
                  <div className="border border-line px-2.5 py-1 rounded font-mono text-xs text-ledger bg-paper font-bold">
                    GPA: 3.88
                  </div>
                </div>
                ...
                <div className="pt-3 border-t border-line flex items-center justify-between text-xs font-mono text-ink-muted">
                  <span>Term Attendance: <strong className="text-ledger font-semibold">98.5% (65/66 Days)</strong></span>
            ...
            <div className="lg:col-span-7 order-2 lg:order-1">
              <div className="paper-card rounded-md shadow-ledger p-5 bg-paper-light space-y-3 border border-line">
                ...
                <div className="space-y-2.5 font-mono text-xs">
                  ...
                  <div className="p-3 bg-paper border border-line rounded flex items-start justify-between">
                    <div>
                      <span className="text-[10px] uppercase text-brass-dark font-bold">Grade Published</span>
                  ...
                  <div className="p-3 bg-paper border border-line rounded flex items-start justify-between">
                    <div>
                      <span className="text-[10px] uppercase text-ledger font-bold">Receipt Logged</span>
