  ...
  return (
    <div className="min-h-screen flex flex-col bg-paper text-ink">
      ...
      <div className="flex-1 flex min-h-screen">
        {/* Paper & Ink Ledger Sidebar */}
        <aside className="w-16 lg:w-64 bg-paper-light border-r-2 border-line flex flex-col shrink-0 sticky top-0 h-screen overflow-y-auto scrollbar-clean">
          {/* Institution Header / Logo */}
          <div className="p-4 lg:px-5 lg:py-4.5 border-b-2 border-line flex items-center justify-between">
            <Link
              href={homeHref}
              className="flex items-center gap-2.5 group"
            >
              <div className="w-8 h-8 rounded bg-ledger flex items-center justify-center text-paper shadow-ledger group-hover:bg-ledger-hover transition-colors">
                <Image src="/logo.png" alt="logo" width={22} height={22} className="brightness-200" />
              </div>
              <div className="hidden lg:flex flex-col">
                <span className="font-serif font-bold text-base text-ink tracking-tight leading-tight">
                  Alpha EduHub
                </span>
